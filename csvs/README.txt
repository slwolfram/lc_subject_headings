...
I also included the catalog record data I was able to extract (itemrecords.csv) and item_subjectheadings, which gives the subjectheading assignments for item records. 

EDIT: Although they should be within Githubs filesize limit, I'm having issues getting the itemrecords and item_subjectheadings to upload-- hopefully I will resolve this before you read this message, but if I haven't and you want these csvs send me an email and I can get them to you!
